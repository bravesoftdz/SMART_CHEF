...
begin
  result := 'update or insert into ITENS_DELETADOS (CODIGO ,CODIGO_PEDIDO ,CODIGO_USUARIO ,codigo_produto, QUANTIDADE ,HORA_EXCLUSAO ,JUSTIFICATIVA) '+
            '                     values ( :CODIGO, :CODIGO_PEDIDO, :CODIGO_USUARIO, :codigo_produto, :QUANTIDADE, :HORA_EXCLUSAO , :JUSTIFICATIVA) ';
end;
