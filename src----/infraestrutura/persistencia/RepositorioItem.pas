...
begin
   result := 'update or insert into Itens(codigo,   codigo_pedido,  codigo_produto, valor_Unitario,  hora,  quantidade,  impresso, codigo_usuario, fracionado, QUANTIDADE_PG) '+
             '                     values(:codigo, :codigo_pedido, :codigo_produto, :valor_Unitario, :hora, :quantidade, :impresso, :codigo_usuario, :fracionado, :QUANTIDADE_PG) ';
end;
