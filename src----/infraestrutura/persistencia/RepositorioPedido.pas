...
begin
   ...
   if assigned(Pedido.Endereco) then begin
     ...
     writeLn(Arq, Pedido.observacoes);
   end;
   ...
   while x < 5 do begin
     ...
     for i := 0 to Pedido.Itens.Count - 1 do begin
       ...
       if not (assinou) then begin
         ...
         if (Pedido.codigo_comanda = 0) and (Pedido.Codigo_endereco > 0) then
            Writeln(Arq, ' * PEDIDO PARA ENTREGA *')
         else if (Pedido.codigo_comanda = 0) and (Pedido.Codigo_endereco = 0) then begin
