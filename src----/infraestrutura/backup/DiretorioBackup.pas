...
type
  ...
  private
    ...
    procedure SetDiretorioPrincipal(const Value: Boolean);
  ...
  public
    ...
    property DiretorioPrincipal :Boolean  read FDiretorioPrincipal write SetDiretorioPrincipal;
...
begin
   self.FCodigo             := 0;
   self.FCaminho            := '';
   self.FDiretorioPrincipal := false;
   self.FUsuario            := nil;
end;
...
procedure TDiretorioBackup.SetDiretorioPrincipal(const Value: Boolean);
begin
  FDiretorioPrincipal := Value;
end;
