object BuscaComanda: TBuscaComanda
  Left = 0
  Top = 0
  Width = 208
  Height = 65
  ...
  object edtNumeroComanda: TEdit
    ...
    ParentFont = False
    TabOrder = 3
    OnChange = edtNumeroComandaChange
    OnExit = edtNumeroComandaExit
  end
  object btnFormaBusca: TBitBtn
    Left = 8
    Top = 43
    Width = 103
    Height = 21
