...
type
  ...
  public
    procedure adiciona_item(Produto :TProduto; quantidade, valor :Real; impresso :String; codigo_usu :integer; hora, fracionado: String; quantidade_paga :Real; const codigo :integer = 0);
...
procedure TfrmPedido.adiciona_item(Produto: TProduto; quantidade, valor :Real; impresso :String; codigo_usu :integer; hora, fracionado: String; quantidade_paga :Real; const codigo :integer);
begin
...
begin
  ...
  while not cdsAdicionais.Eof do begin
    ...
    if cdsAdicionaisFLAG.AsString = 'A' then begin
      ...
      total_adicionados := total_adicionados + ( cdsAdicionaisVALOR.AsFloat * cdsItensQUANTIDADE.AsFloat);
    end;
...
begin
 ...
 try
   ...
   buscaComanda1.Pedido.situacao        := IfThen(finalizando,'F', 'A');

   buscaComanda1.Pedido.sts_recebimento := IfThen(finalizando,'F', 'P');

   if finalizando and (buscaComanda1.Pedido.valor_pago > 0) then
     buscaComanda1.Pedido.observacoes := 'VALOR TOTAL: R$'+ TStringUtilitario.FormataDinheiro(buscaComanda1.Pedido.valor_total)+
