inherited frmRelatorioVendas: TfrmRelatorioVendas
  ...
  object qryVendas: TZQuery
    ...
    SQL.Strings = (
      ...
      ' sum(i.valor_unitario * i.quantidade) vlr_total_it,'
    ...
    object qryVendasQTDE: TFloatField
      FieldName = 'QTDE'
      ReadOnly = True
    end
    object qryVendasVLR_UNI: TFloatField
      FieldName = 'VLR_UNI'
      ReadOnly = True
      DisplayFormat = ' ,0.00;-,0.00'
    end
    object qryVendasVLR_TOTAL_IT: TFloatField
      FieldName = 'VLR_TOTAL_IT'
      ReadOnly = True
      DisplayFormat = ' ,0.00;-,0.00'
    end
    object qryVendasVLR_TOTAL_AD: TFloatField
