...
begin
  result := 'update or insert into CONFIGURACOES_SISTEMA (CODIGO ,POSSUI_BOLICHE ,POSSUI_DISPENSADORA ,DUAS_VIAS_PEDIDO, preco_produto_alteravel, Utiliza_comandas, possui_delivery) '+
           '                      values ( :CODIGO , :POSSUI_BOLICHE , :POSSUI_DISPENSADORA , :DUAS_VIAS_PEDIDO, :preco_produto_alteravel, :Utiliza_comandas, :possui_delivery) ';
end;
