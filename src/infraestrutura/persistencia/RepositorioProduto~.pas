...
begin
   result := 'update or insert into Produtos ( codigo,  codigo_grupo,  descricao,  valor,  ativo,  codigo_departamento,  codigo_ibpt,  tipo,  icms,  tributacao, preparo) '+
             '                        values (:codigo, :codigo_grupo, :descricao, :valor, :ativo, :codigo_departamento, :codigo_ibpt, :tipo, :icms, :tributacao, :preparo) ';
end;
