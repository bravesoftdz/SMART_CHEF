...
begin
  result := 'update or insert into ESTOQUE (CODIGO ,CODIGO_PRODUTO ,CODIGO_DISPENSA ,QUANTIDADE ,UNIDADE_MEDIDA ,PECAS) '+
           '                      values ( :CODIGO , :CODIGO_PRODUTO , :CODIGO_DISPENSA , :QUANTIDADE , :UNIDADE_MEDIDA , :PECAS) ';
end;
