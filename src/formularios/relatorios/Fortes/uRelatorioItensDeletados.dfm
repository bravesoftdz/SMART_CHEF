inherited frmRelatorioItensDeletados: TfrmRelatorioItensDeletados
  Left = 473
  Top = 217
  ...
  object RLReport1: TRLReport [3]
    ...
    object RLBand4: TRLBand
      ...
      object RLLabel4: TRLLabel
        ...
        Width = 257
        Height = 17
        Caption = 'TOTAL GERAL DE ITENS EXCLU'#205'DOS >>>'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -13
        Font.Name = 'Segoe UI'
    ...
    object RLGroup1: TRLGroup
      ...
      object RLBand5: TRLBand
        ...
        object RLLabel3: TRLLabel
          ...
          Width = 192
          Height = 17
          Caption = 'TOTAL ITENS EXCLU'#205'DOS >>>'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          Font.Name = 'Segoe UI'
  ...
  inline BuscaUsuario1: TBuscaUsuario
    Left = 147
    Top = 96
    Width = 442
    Height = 48
  ...
  object dsItensDel: TDataSource
    DataSet = qryItensDel
    Left = 472
    Top = 72
  end
  object qryItensDel: TFDQuery
    SQL.Strings = (
      
        'select id.codigo, id.codigo_usuario, cast(id.quantidade as integ' +
        'er) quantidade, id.hora_exclusao,'
    ...
    Left = 376
    Top = 72
    object qryItensDelCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qryItensDelCODIGO_USUARIO: TIntegerField
      FieldName = 'CODIGO_USUARIO'
      Origin = 'CODIGO_USUARIO'
    end
    object qryItensDelQUANTIDADE: TIntegerField
    ...
    object qryItensDelHORA_EXCLUSAO: TTimeField
      FieldName = 'HORA_EXCLUSAO'
      Origin = 'HORA_EXCLUSAO'
    end
    object qryItensDelJUSTIFICATIVA: TStringField
      FieldName = 'JUSTIFICATIVA'
      Origin = 'JUSTIFICATIVA'
      Size = 200
    end
    object qryItensDelDATA: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'DATA'
      Origin = '"DATA"'
      ProviderFlags = []
    ...
    object qryItensDelDESCRICAO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object qryItensDelNOME: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'NOME'
      Origin = 'NOME'
      ProviderFlags = []
