...
type
  TfrmRelatorioEntradaSaida = class(TfrmPadrao)
    ...
    qryQUANTIDADE: TSingleField;
    qryPRECO_CUSTO: TSingleField;
...
procedure TfrmRelatorioEntradaSaida.BitBtn2Click(Sender: TObject);
begin
  self.Close;
end;

procedure TfrmRelatorioEntradaSaida.FormShow(Sender: TObject);
begin
