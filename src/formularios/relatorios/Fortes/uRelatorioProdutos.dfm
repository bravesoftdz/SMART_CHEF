inherited frmRelatorioProdutos: TfrmRelatorioProdutos
  ...
  object qryProdutos: TFDQuery
    SQL.Strings = (
      'select p.codigo, p.descricao, p.valor,                    '
      ' iif(p.codigo_grupo is null, 0, p.codigo_grupo) codgrupo, '
      ' iif(g.descricao is null,  '#39'SERVI'#199'O'#39', g.descricao) grupo'
      ' from produtos p                                          '
    ...
    object qryProdutosCODGRUPO: TIntegerField
