...
uses Generics.Collections, System.SysUtils, Math, Estoque, Pedido, Repositorio, FabricaRepositorio,
     ProdutoHasMateria, AdicionalItem, EspecificacaoEstoquePorProduto, Item;
