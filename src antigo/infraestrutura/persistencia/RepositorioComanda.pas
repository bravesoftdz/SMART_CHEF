...
begin
   ...
   if (ComandaAntigo.motivo <> ComandaNovo.motivo) then
    Auditoria.AdicionaCampoAlterado('motivo', ComandaAntigo.motivo, ComandaNovo.motivo);
...
begin
   ...
   Auditoria.AdicionaCampoExcluido('motivo',         Comanda.motivo);
end;
...
begin
   ...
   Auditoria.AdicionaCampoIncluido('motivo',         Comanda.motivo);
end;
...
begin
   ...
   if Comanda.ativa then inherited SetParametro('ativa', 'S')
