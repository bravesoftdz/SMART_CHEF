...
uses Cliente, repositorio, fabricarepositorio, StrUtils, CurrEdit, uModulo, funcoes,
...
begin
  ...
  try
    ...
    self.cpfCnpj.edtCpf.Text         :=  Cliente.cpf_cnpj;
    self.cpfCnpj.comPessoaChange(nil);
