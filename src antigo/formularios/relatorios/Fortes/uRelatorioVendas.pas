...
uses
  ...
  frameListaCampo, DB, ZAbstractRODataset, ZAbstractDataset,
  ZDataset, ComCtrls, DBClient, RLFilters, RLPDFFilter;
...
type
  TfrmRelatorioVendas = class(TfrmPadrao)
    ...
    qryVendasQTDE: TFloatField;
    qryVendasVLR_UNI: TFloatField;
    qryVendasVLR_TOTAL_IT: TFloatField;
    RLGroup1: TRLGroup;
    RLBand2: TRLBand;
    RLLabel1: TRLLabel;
    RLLabel2: TRLLabel;
    ...
    rlbUsuario: TRLLabel;
    RLDraw9: TRLDraw;
    qryVendasVLR_TOTAL_AD: TFloatField;
    RLDBText2: TRLDBText;
    RLLabel25: TRLLabel;
...
begin
  ...
  qryVendas.SQL.Text := 'select iif( gr.codigo is null, 0, gr.codigo) codgrupo ,        '+
                        ...
                        ' sum(i.valor_unitario * iif(i.quantidade > 599, 1, i.quantidade )) vlr_total_it,            '+
  ...
  qryVendas.SQL.Add(' group by gr.codigo , gr.descricao , p.descricao, i.codigo, i.quantidade ');
