...
type
  ...
  private
    ...
    function GetListaDispensa: TobjectList;
  ...
  public
    ...
    property ListaDispensa       :TobjectList read GetListaDispensa;

end;

implementation

uses repositorio, fabricaRepositorio, EspecificacaoMateriasDoProduto, EspecificacaoDependenciaEstoqueProduto, ProdutoHasMateria,
...
function TProduto.GetListaDispensa: TobjectList;
var
  Repositorio   :TRepositorio;
  Especificacao :TEspecificacaoDependenciaEstoqueProduto;
begin
   Repositorio    := nil;
   Especificacao  := nil;

   try
      if not Assigned(self.FListaDispensa) then begin
        Especificacao         := TEspecificacaoDependenciaEstoqueProduto.Create(self.Fcodigo);
        Repositorio           := TFabricaRepositorio.GetRepositorio(TProdutoDependenciaEst.ClassName);
        self.FListaDispensa   := Repositorio.GetListaPorEspecificacao(Especificacao);
      end;

      result := self.FListaDispensa;
   finally
